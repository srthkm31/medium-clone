        ...
        <div className="flex justify-between w-full pr-10 pl-10">
          ...
          <div className="flex justify-between gap-7 items-center ">
            ...
            <button
              ...
              disabled={loading}
              className="relative bg-black/90 hover:bg-black cursor-pointer text-white rounded-full pl-4 pr-4 pt-2 pb-2 text-sm flex items-center justify-center min-h-[36px]"
            >
          ...
          <div className="flex justify-between gap-10 items-center ">
            <p className="text-sm">
              {loggedIn ? (
                ...
                <a href="/signin?from=${pageContext.request.requestURI}">
                  Write
                </a>
              )}
            </p>
            ...
            <button
              className="bg-black/90 hover:bg-black cursor-pointer text-white rounded-full pl-4 text-sm  pr-4 pt-2 pb-2"
              onClick={() => {
                getStartedHandler();
              }}
            >
